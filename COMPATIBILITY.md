...
| Llama 3.2 1B Instruct Q8_0 | Supported exact-row smoke | Exact-row load, compact/broader parity, API smoke, frontend smoke, and the first bounded 512-context pack are supported for this exact row only. | Normalize broader/larger context, chat-template, memory/perf, portability, and durable bundle evidence to the TinyLlama bar before any broader/full-support claim. |
| Llama 3.2 3B Instruct Q8_0 | Supported exact-row smoke | Exact-row load, compact prompt-token/1-token/5-token/50-token parity, broader three-prompt 50-token parity, API smoke, frontend smoke, and the first bounded 512-context pack are supported for this exact row only. | Normalize broader/larger context, chat-template, memory/perf, portability, and durable bundle evidence to the TinyLlama bar before any broader/full-support claim. |
...
- **Validated now:** metadata, tokenizer path, tensor load, compact parity, broader prompt-pack parity, the first bounded 512-context pack, `/api/models/load`, `/v1/completions`, `/v1/chat/completions`, and frontend smoke are validated for the exact 1B Instruct Q8_0 row
- **Missing gates:** broader/larger context beyond the checked 512 pack, broader chat-template behavior, stronger memory/performance evidence, and portable packaging
...
- **Family / quant:** LLaMA decoder + Llama 3 BPE, Q8_0
- **Validated now:** the exact tracked GGUF has validated metadata/load, compact prompt-token plus deterministic 1-token/5-token/50-token parity, broader three-prompt 50-token parity, the first bounded 512-context pack, `/v1/completions`, `/v1/chat/completions`, frontend smoke, and a five-prompt API smoke pack
- **Missing gates:** broader/larger context beyond the checked 512 pack, stronger memory/performance follow-up evidence, portable packaging, and broader chat-template coverage
...
For **Llama 3.2 1B** specifically, the committed carry-forward row bundle at `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_1b_instruct_q8_0.bundle.json`, the current-head row manifest at `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_1b_instruct_q8_0/manifest.json`, and the four-row context bundle at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json` are the durable citation anchors for the exact-row smoke and first bounded 512-context boundary. Larger context, broader chat-template, perf, and portability reruns remain exact-row follow-up work.

For **Llama 3.2 3B** specifically, the committed carry-forward row bundle at `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_3b_instruct_q8_0.bundle.json` preserves the exact-row API/WebUI/compact-parity smoke boundary, the current-head row manifest at `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_3b_instruct_q8_0/manifest.json` is the durable citation target for the post-Q8-dot broader three-prompt handoff, and the four-row context bundle at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json` records the first bounded 512-context pass. The next promotable evidence is still larger/broader context, stronger performance/portability, and broader chat-template coverage before expanding the claim.
