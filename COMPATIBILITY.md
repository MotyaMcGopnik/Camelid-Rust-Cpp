...
| 1k / 2k tokens | Row-specific only | Llama 3.2 1B/3B have checked 1024-context and 2048-context passes. Llama 3 8B 1024/2048 attempts are blocked by backend timeout, so 8B long-context promotion is paused pending performance/memory architecture work and fresh PASS artifacts. |
