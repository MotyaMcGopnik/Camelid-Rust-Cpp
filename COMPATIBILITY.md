...
| Llama 3 8B Instruct Q8_0 | Supported exact-row smoke with compact parity, broader 50-token parity, API/WebUI, bounded memory evidence, 512/1024/2048-context, compact template-shapes, and lazy-Q8 hot-path measurements. | 512, 1024, and 2048 bounded packs are green. | Model-native/larger context beyond the checked packs, arbitrary-template behavior, production-throughput/portability support, or broad 8B/Llama-family support. |
...
- `qa/evidence-bundles/llama3-8b-context-2048-20260506T144037Z-head-ae672d935a9d/manifest.json` plus `SHA256SUMS` records the clean-current-public-main third bounded 2048-context pass for the exact Llama 3 8B Instruct Q8_0 row only.
...
| Llama 3.2 1B Instruct Q8_0 | Supported exact-row smoke | Exact-row load, compact/broader parity, API smoke, frontend smoke, the first bounded 512-context pack, the second bounded 1024-context pack, the third bounded 2048-context pack after the RoPE frequency-factor fix, the bounded compact chat-template-shapes pack, and the bounded unique-chat perf/RSS envelope are supported for this exact row only. | Normalize model-native/larger context beyond the checked packs, arbitrary/Jinja template behavior beyond the checked compact pack, production throughput, portability, and durable bundle evidence to the TinyLlama bar before any broader/full-support claim. |
| Llama 3.2 3B Instruct Q8_0 | Supported exact-row smoke | Exact-row load, compact prompt-token/1-token/5-token/50-token parity, broader three-prompt 50-token parity, API smoke, frontend smoke, the first bounded 512-context pack, the second bounded 1024-context pack, the third bounded 2048-context pack, the bounded compact chat-template-shapes pack, the bounded unique-chat perf/RSS envelope, and the opt-in parallel Q8 first-token runtime direction sub-box are supported for this exact row only. | Normalize model-native/larger context beyond the checked packs, arbitrary/Jinja template behavior beyond the checked compact pack, production throughput beyond the first-token direction probe, portability, and durable bundle evidence to the TinyLlama bar before any broader/full-support claim. |
| Llama 3 8B Instruct Q8_0 | Supported exact-row smoke | Compact parity, three-prompt 50-token parity, API/frontend smoke, bounded-memory evidence, the first bounded 512-context pack, the current-head second bounded 1024-context pack, the current-head third bounded 2048-context pack, the bounded compact chat-template-shapes pack, and measurement-only lazy-Q8 hot-path cost probes support this exact row only. The 1024 and 2048 passes are bounded exact-row pack claims only. | Preserve the bounded 1024/2048 proof while continuing KV/cache and attention memory behavior, Q8 matmul/output-projection hot paths, dense/f32 materialization avoidance, chunked/streamed long-context prefill, per-layer timing/RSS-peak instrumentation, production throughput, portability, and arbitrary-template work before any broader/full claim. |
...
- **Family / quant:** LLaMA decoder + Llama 3 BPE, Q8_0
- **Validated now:** the exact tracked GGUF has validated metadata/load, compact prompt-token plus deterministic 1-token/5-token/50-token parity, broader three-prompt 50-token parity, the first bounded 512-context pack, the second bounded 1024-context pack, the third bounded 2048-context pack, the bounded compact chat-template-shapes pack, the bounded unique-chat perf/RSS envelope, the opt-in parallel Q8 first-token runtime direction sub-box, `/v1/completions`, `/v1/chat/completions`, frontend smoke, and a five-prompt API smoke pack
- **Missing gates:** model-native/larger context beyond the checked 512/1024/2048 packs, production throughput beyond the first-token direction probe, portable packaging, and arbitrary/Jinja template coverage beyond the checked compact pack
...
- **Family / quant:** LLaMA decoder + Llama 3 BPE, Q8_0
- **Validated now:** metadata/config/template handling, tokenizer reference parity, compact `hello` prompt-token/1-token/5-token/50-token parity, the three-prompt 50-token Ubuntu parity run, the first bounded 512-context pack, the current-head second bounded 1024-context pack, the current-head third bounded 2048-context pack, the bounded compact chat-template-shapes pack, `/v1/completions`, `/v1/chat/completions`, frontend smoke, bounded-memory evidence, and retained-block lazy-Q8 hot-path cost probes are validated for the exact 8B Instruct Q8_0 row
- **Bounded-only context:** the second bounded 1024-context pack and third bounded 2048-context pack are promoted only as copied/scrubbed current-head public bundles; model-native/larger context beyond those checked packs remains unsupported
- **Runtime follow-up:** chunked prefill/Q8 read-reuse and lazy-Q8 runtime work now have row-specific 1024/2048 parity/timing proof for those bounded packs, but broader/full support still needs separate production-throughput, portability, arbitrary-template, and larger-context evidence
...
- **Support boundary:** supported exact-row smoke plus checked 512/1024/2048 bounded packs only for this exact Llama 3 8B Instruct Q8_0 row; no broader/full-support, larger/model-native-context, arbitrary-template, or neighboring-row claim yet
...
For **Llama 3.2 1B** specifically, the committed carry-forward row bundle at `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_1b_instruct_q8_0.bundle.json`, the current-head row manifest at `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_1b_instruct_q8_0/manifest.json`, the four-row context bundle at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json`, the second bounded 1024-context bundle at `qa/evidence-bundles/llama32-1b-context-1024-20260505T081001Z-head-156ded6fc76b/manifest.json`, the third bounded 2048-context bundle at `qa/evidence-bundles/llama32-1b-context-2048-rope-factors-20260506T0105Z-head-62f8cbc/manifest.json`, the compact template-shapes bundle at `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json`, and the unique-chat perf/RSS bundle at `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json` are the durable citation anchors for the exact-row smoke, first bounded 512-context boundary, second bounded 1024-context boundary, third bounded 2048-context boundary, bounded compact template-shape boundary, and bounded memory/perf envelope. The earlier 2048 blocker notes remain superseded history. Model-native/larger context, arbitrary/Jinja template behavior, production throughput, and portability reruns remain exact-row follow-up work.

For **Llama 3.2 3B** specifically, the committed carry-forward row bundle at `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_3b_instruct_q8_0.bundle.json` preserves the exact-row API/WebUI/compact-parity smoke boundary, the current-head row manifest at `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_3b_instruct_q8_0/manifest.json` is the durable citation target for the post-Q8-dot broader three-prompt handoff, the four-row context bundle at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json` records the first bounded 512-context pass, the exact 3B context bundles at `qa/evidence-bundles/llama32-3b-context-1024-20260505T094258Z-head-c14e5e7b5692/manifest.json` and `qa/evidence-bundles/llama32-3b-context-2048-20260505T105742Z-head-36ec8e492d65/manifest.json` record the second bounded 1024-context and third bounded 2048-context passes, the compact template-shapes bundle at `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json` records bounded compact template-shape coverage, the unique-chat perf/RSS bundle at `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json` records the bounded memory/perf envelope, and `qa/evidence-bundles/llama32-3b-parallel-q8-first-token-20260505T140400Z-head-ffc22b85214f/manifest.json` records the opt-in parallel Q8 first-token runtime direction sub-box. The next promotable evidence is still model-native/larger context beyond the checked packs, production throughput beyond this first-token direction probe, portability, and arbitrary/Jinja template coverage before expanding the claim.

For **Llama 3 8B** specifically, the durable citation anchors are the current-head row manifest at `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama3_8b_instruct_q8_0/manifest.json`, the committed perf/portability envelope at `qa/evidence-bundles/four-row-perf-portability-public-20260503T025639Z/compact-perf-portability-envelope.json`, the broader three-prompt 50-token rerun bundle at `qa/evidence-bundles/llama3-8b-broader-50tok-20260505T005031Z-head-d13541ad8d7e/manifest.json`, the four-row 512-context bundle at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json`, the earlier exact-8B 512-context rerun bundle at `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json`, the compact chat-template-shapes rerun bundle at `qa/evidence-bundles/llama3-8b-chat-template-shapes-20260505T003821Z-head-d13541ad8d7e/manifest.json`, the current-public-head normalized API/WebUI/RSS bundle at `qa/evidence-bundles/full-support-normalized-wp2-8b-watchdog-20260505T041404Z-head-83c21f0cbf5a/manifest.json`, the 1024-context diagnostic-history note at `qa/validation-notes/2026-05-05-llama3-8b-context-1024-blocker.md`, the superseded 2048-context timeout note at `qa/validation-notes/2026-05-05-llama3-8b-context-2048-blocker.md`, the current-head 1024 PASS bundle at `qa/evidence-bundles/llama3-8b-context-1024-20260506T144810Z-head-ae672d935a9d/manifest.json`, the current-head 2048 PASS bundle at `qa/evidence-bundles/llama3-8b-context-2048-20260506T144037Z-head-ae672d935a9d/manifest.json`, the earlier public-main exact-row checkmark refresh at `qa/evidence-bundles/8b-checkmark-current-head-20260505T052647Z-head-864e07b51f36/manifest.json`, the latest public-main exact-row checkmark refresh at `qa/evidence-bundles/8b-checkmark-current-main-20260505T084931Z-head-15bfc41d15d5/manifest.json`, the measurement-only retained-block lazy-Q8 hot-path bundle at `qa/evidence-bundles/llama3-8b-lazy-q8-hotpath-20260505T021411Z-head-723a665/manifest.json`, and the helper-validation repeat at `qa/evidence-bundles/llama3-8b-lazy-q8-hotpath-helper-validated-20260505T0350Z-head-e22307f2f90b/manifest.json`; the public carry-forward bundle at `qa/evidence-bundles/four-row-public-20260503T024327Z/llama3_8b_instruct_q8_0.bundle.json` is intentionally a pre-promotion guarded-WebUI smoke slice from source smoke commit `c5e6d7e`. That keeps the exact-row smoke promotion boundary plus the cleared broader 50-token, single-pack 512-context, current-head bounded 1024/2048-context, compact-template-shape, and hot-path measurement results visible without widening beyond this row.
...
| LLaMA decoder + Llama 3 BPE | Exact-row smoke supported; broader support pending normalization | The Llama 3.2 1B/3B and Llama 3 8B rows now share a passing first bounded 512-context pack; the 1B/3B rows each have passing second bounded 1024-context packs and passing third bounded 2048-context packs, and the 8B row now has a current-head passing second bounded 1024-context pack and third bounded 2048-context pack. The 1B row has compact/broader parity plus API/WebUI smoke and a bounded unique-chat perf/RSS envelope; the 3B row has compact and broader 50-token parity plus API/WebUI smoke and a bounded unique-chat perf/RSS envelope; the 8B row adds compact parity, 50-token broader parity, API/WebUI smoke, bounded-memory evidence, a passing compact chat-template-shapes pack, measurement-only retained-block lazy-Q8 hot-path costs, and current-head passing second bounded 1024-context/third bounded 2048-context packs. Those exact rows are smoke-supported only; broader/full support still waits on repeated current-head 50-token, API, WebUI, memory-bound, model-native/larger context, and durable-bundle normalization. |
...
| 512 tokens | First bounded pack pass for all four exact Q8_0 rows; broader context still planned | Phase 13 audit bucket. The first bounded 512-context pack now passes for TinyLlama plus the exact Llama 3.2 1B/3B and Llama 3 8B rows, but this is one pack only; 1k/2k, model-native context, and performance portability remain unpromoted. The exact 8B compact chat-template-shapes pack also passes, but arbitrary template execution and broader template coverage remain unpromoted. |
| 1k / 2k tokens | Row-specific only | Llama 3.2 1B/3B have checked 1024-context and 2048-context passes. Llama 3 8B has checked current-head 1024-context and 2048-context passes. Model-native/larger context and broad/full 8B support remain pending performance/memory, throughput, template, and portability evidence. |
...
- **Phase 11 — Llama 3 / Backend + QA:** keep broad Llama 3 below support until each concrete target has the right artifact-backed evidence. For Llama 3.2 1B Q8_0, exact-row short-chat smoke support is now strengthened by a passing three-prompt known-good-baseline pack in the downloaded-model matrix, the first bounded 512-context pack, the second bounded 1024-context pack, and the third bounded 2048-context pack after the RoPE frequency-factor fix. For Llama 3.2 3B Q8_0, exact-row smoke support is now strengthened by compact parity, API, frontend, smoke-pack evidence, the post-Q8-dot clean broader three-prompt 50-token parity rerun, the first bounded 512-context pack, the second bounded 1024-context pack, and the third bounded 2048-context pack; model-native/larger-context, performance/portability, and broader chat-template evidence remain the next requirements before widening the row. For Llama 3 8B, compact prompt-token, 1-token, 5-token, bounded 50-token parity, the three-prompt 50-token broader pass, basic API/frontend smoke, the first bounded 512-context pack, the current-head second bounded 1024-context pack, the current-head third bounded 2048-context pack, and bounded memory evidence now support the exact row. The 1024 and 2048 passes are bounded exact-row pack claims only. Under Tim's rule, keep further Backend/Performance work focused on KV/cache and attention memory behavior, Q8 matmul/output-projection hot paths, dense/f32 materialization avoidance, chunked/streamed long-context prefill, and per-layer timing/RSS-peak instrumentation, preserving TinyLlama/1B/3B short-context guardrails and serial/block-aligned determinism until optimized kernels have separate zero-delta evidence.
...
Current evidence handoff: Llama 3 8B now has compact-header `hello` parity against llama.cpp for prompt tokens plus deterministic 1-token, 5-token, and bounded 50-token generation, basic API/frontend smoke, bounded memory evidence, a passing three-prompt 50-token Ubuntu parity run, the first bounded 512-context pack, clean-current-head second bounded 1024-context and third bounded 2048-context PASS bundles, and a retained-block lazy-Q8 hot-path cost bundle for representative FFN/output tensors for the exact same row. The next broader/full status-changing work is performance/memory architecture plus instrumentation followed by fresh row-specific artifacts. Current `bench-q8-blocks` memory fields and representative attention Q/K/V/output, FFN, and output-projection shape evidence should travel with that handoff: retained Q8 payload, avoided `f32` materialization, bounded dot input, optional all-row output vector, and the guarded swapped rank-2 logical row/column interpretation distinguish safe lazy-execution scratch/output buffers from unsafe eager `f32` weight decoding. The deterministic-parallelism metadata should travel too: current Q8 block rows are serial-only, no parallel Q8 kernel is enabled by default, and any future serial-vs-parallel comparison must target zero delta with a `1e-7` fail threshold before it can affect support claims. The independent reference token dumps for the existing Llama 3 fixture prompts are complete for tokenizer parity evidence, but they do not unlock broader 8B generation support by themselves.
