...
Reopened-lane API + frontend smoke: `qa/evidence-bundles/four-row-api-webui-20260505T003100Z-head-b403884/manifest.json` records passing exact-row release build, frontend build/model-state smoke, API load/models/capabilities/completions/chat checks, and frontend smoke for TinyLlama, Llama 3.2 1B, Llama 3.2 3B, and Llama 3 8B Q8_0 on clean public `main` head `b403884`. Treat it as freshness evidence for the exact smoke rows only; it does not replace parity packs, performance portability, or broader context validation. The earlier API-only summary remains at `qa/evidence-bundles/four-row-api-only-20260504T230722Z-head-13a465608fbf/manifest.json`; the 1B/3B chat-template-shapes pack at `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json` closes only the bounded compact template-shape pack for those two exact rows; the 1B/3B unique-chat perf/RSS pack at `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json` closes only the bounded memory/perf envelope box for those exact rows; the 1B second bounded 1024-context pack at `qa/evidence-bundles/llama32-1b-context-1024-20260505T081001Z-head-156ded6fc76b/manifest.json` closes only that exact 1B context box; the 3B second bounded 1024-context pack at `qa/evidence-bundles/llama32-3b-context-1024-20260505T094258Z-head-c14e5e7b5692/manifest.json` closes only that exact 3B context box; the follow-up 8B broader pack at `qa/evidence-bundles/llama3-8b-broader-50tok-20260505T005031Z-head-d13541ad8d7e/manifest.json` closes only the three-prompt 50-token pack; the four-row context pack at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json` closes only the first bounded 512-context pack for the four exact Q8_0 rows; the earlier 8B context pack at `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json` closes only the exact 8B first bounded 512-context timeout; the 8B chat-template-shapes pack at `qa/evidence-bundles/llama3-8b-chat-template-shapes-20260505T003821Z-head-d13541ad8d7e/manifest.json` closes only the bounded compact template-shape pack; and the retained-block lazy-Q8 hot-path bundle at `qa/evidence-bundles/llama3-8b-lazy-q8-hotpath-20260505T021411Z-head-723a665/manifest.json` measures representative costs only for that exact 8B row.
...
| Llama 3.2 1B Instruct Q8_0 | Supported exact-row smoke | Exact-row load, compact/broader parity, API smoke, frontend smoke, the first bounded 512-context pack, the second bounded 1024-context pack, the bounded compact chat-template-shapes pack, and the bounded unique-chat perf/RSS envelope are supported for this exact row only. | Normalize model-native/larger context beyond the checked packs, arbitrary/Jinja template behavior beyond the checked compact pack, production throughput, portability, and durable bundle evidence to the TinyLlama bar before any broader/full-support claim. |
| Llama 3.2 3B Instruct Q8_0 | Supported exact-row smoke | Exact-row load, compact prompt-token/1-token/5-token/50-token parity, broader three-prompt 50-token parity, API smoke, frontend smoke, the first bounded 512-context pack, the second bounded 1024-context pack, the bounded compact chat-template-shapes pack, and the bounded unique-chat perf/RSS envelope are supported for this exact row only. | Normalize model-native/larger context beyond the checked packs, arbitrary/Jinja template behavior beyond the checked compact pack, production throughput, portability, and durable bundle evidence to the TinyLlama bar before any broader/full-support claim. |
| Llama 3 8B Instruct Q8_0 | Supported exact-row smoke | Compact parity, three-prompt 50-token parity, API/frontend smoke, bounded-memory evidence, the first bounded 512-context pack, the bounded compact chat-template-shapes pack, and measurement-only lazy-Q8 hot-path cost probes support this exact row only. | Repeat current-head evidence as needed, broaden 1k/2k and template coverage, close production performance/RSS bounds, and publish portability evidence before any broader/full-support claim. The approved Ubuntu validation lane is reopened; the 512-context and compact template-shape gaps are cleared only for the checked packs, and the hot-path probe is not a portability claim. |
...
- **Family / quant:** LLaMA decoder + Llama 3 BPE, Q8_0
- **Validated now:** the exact tracked GGUF has validated metadata/load, compact prompt-token plus deterministic 1-token/5-token/50-token parity, broader three-prompt 50-token parity, the first bounded 512-context pack, the second bounded 1024-context pack, the bounded compact chat-template-shapes pack, the bounded unique-chat perf/RSS envelope, `/v1/completions`, `/v1/chat/completions`, frontend smoke, and a five-prompt API smoke pack
- **Missing gates:** model-native/larger context beyond the checked 512/1024 packs, production throughput evidence, portable packaging, and arbitrary/Jinja template coverage beyond the checked compact pack
