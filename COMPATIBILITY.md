...
| Llama 3.2 3B Instruct Q8_0 | Supported exact-row smoke | Exact-row load, compact prompt-token/1-token/5-token/50-token parity, broader three-prompt 50-token parity, API smoke, frontend smoke, the first bounded 512-context pack, the second bounded 1024-context pack, the third bounded 2048-context pack, the bounded compact chat-template-shapes pack, and the bounded unique-chat perf/RSS envelope are supported for this exact row only. | Normalize model-native/larger context beyond the checked packs, arbitrary/Jinja template behavior beyond the checked compact pack, production throughput, portability, and durable bundle evidence to the TinyLlama bar before any broader/full-support claim. |
...
- **Family / quant:** LLaMA decoder + Llama 3 BPE, Q8_0
- **Validated now:** the exact tracked GGUF has validated metadata/load, compact prompt-token plus deterministic 1-token/5-token/50-token parity, broader three-prompt 50-token parity, the first bounded 512-context pack, the second bounded 1024-context pack, the third bounded 2048-context pack, the bounded compact chat-template-shapes pack, the bounded unique-chat perf/RSS envelope, `/v1/completions`, `/v1/chat/completions`, frontend smoke, and a five-prompt API smoke pack
- **Missing gates:** model-native/larger context beyond the checked 512/1024/2048 packs, production throughput evidence, portable packaging, and arbitrary/Jinja template coverage beyond the checked compact pack
