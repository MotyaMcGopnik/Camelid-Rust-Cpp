...
- Llama 3 8B Instruct Q8_0 is exact-row smoke-supported through checked 512/1024/2048 bounded context packs.
- Broad/full 8B support still requires model-native/larger context beyond checked packs, arbitrary-template, throughput, and portability evidence.
