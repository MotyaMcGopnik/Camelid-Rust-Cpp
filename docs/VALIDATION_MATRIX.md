...
- Llama 3.2 1B Instruct Q8_0 is exact-row smoke-supported through checked 512/1024/2048/4096 bounded context packs where row-specific PASS artifacts are cited; the latest 4096 pack is `qa/evidence-bundles/llama32-1b-context-4096-current-head-20260513T163426Z-head-470388f/manifest.json`. Llama 3.2 3B Instruct Q8_0 is exact-row smoke-supported through checked 512/1024/2048 bounded context packs where row-specific PASS artifacts are cited.
