...
- Llama 3 8B 1024/2048 remain red until fresh current-head PASS artifacts and synchronized docs/API/frontend copy exist; broad/full 8B support still requires model-native/larger context beyond checked packs, arbitrary-template, throughput, and portability evidence.
