...
Current public support is exact-row: TinyLlama Q8_0 is the supported gate, Llama 3.2 1B/3B Q8_0 are checked through bounded 512/1024/2048-context packs, and Llama 3 8B Q8_0 is checked through the bounded 512-context pack only. 8B 1024/2048 remain red until fresh current-head PASS artifacts and synchronized docs/API/frontend copy exist. Do not broaden those claims to model-native/larger context beyond checked packs, production throughput, portability, local experiments, arbitrary templates, or adjacent GGUFs without new evidence bundles and synchronized docs/API/frontend updates.
