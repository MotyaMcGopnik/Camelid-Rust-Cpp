...
- Llama 3.2 3B Q8_0 moved from acceptance target to supported exact-row smoke after exact-row load, compact prompt-token/1-token/5-token/50-token parity, `/v1/completions`, `/v1/chat/completions`, and frontend smoke evidence aligned. Its bounded compact chat-template-shapes box, bounded unique-chat perf/RSS envelope box, second bounded 1024-context parity box, and third bounded 2048-context parity box are now green for the exact row only.
...
- The support claim is limited to this exact 3B Instruct Q8_0 row, the validated local-chat/parity envelope, the checked first bounded 512-context pack, the checked second bounded 1024-context pack, the checked third bounded 2048-context pack, the checked compact chat-template-shapes pack, and the bounded unique-chat perf/RSS envelope; model-native/larger contexts beyond checked packs, portable packaging, arbitrary GGUF/Jinja template execution, broader chat-template coverage, production throughput, and portability remain follow-up gates.
