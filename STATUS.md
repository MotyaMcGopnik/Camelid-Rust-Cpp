...
Today's Mac frontend polish landed two high-confidence UI hot-path quick wins in `frontend/src/hooks/useDashboardData.js`: dashboard polling now reads local conversation/memory/model state through refs instead of depending on token-updating state, and live assistant streaming patches are batched to animation frames while key preparing/generating milestones stay immediate. The main-session frontend pass reported `npm run build`, `npm run smoke:streaming`, `npm run smoke:model-state`, and `npm run smoke:ui` green. A compact exact-row Mac 3B Q8_0 streaming smoke now also records the backend/user-perceived seam: before the streaming-responsiveness patch, first content arrived after about `253.5 s`; after the patch, the stream emitted a role-only SSE chunk in about `91.8 ms` and `/health` stayed responsive during generation. This is frontend/API responsiveness evidence only; it does not close the long first-content latency finding or promote production-throughput, portability, neighboring-row, or broad Llama support.
...
Current operator update: As of 2026-05-12, Tim has paused the Ubuntu validation lane. Do not SSH into validation hosts, do not substitute another remote host, and do not assume promotion-grade runtime validation is available until Tim explicitly reactivates a lane. Historical reopened-lane evidence remains valid only for the exact row, source head, prompt pack, and bounded claim it names: API-only and API + frontend smoke summaries live at `qa/evidence-bundles/four-row-api-only-20260504T230722Z-head-13a465608fbf/manifest.json` and `qa/evidence-bundles/four-row-api-webui-20260505T003100Z-head-b403884/manifest.json`; the TinyLlama final-normalization bundle has a passing public summary at `qa/evidence-bundles/tinyllama-broader-template-context-perf-rss-20260505T044519Z-head-864e07b51f36/manifest.json`; the exact Llama 3.2 1B/3B compact chat-template-shapes pack has a passing public summary at `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json`; the exact Llama 3.2 1B/3B unique-chat perf/RSS pack has a passing public summary at `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json`; the exact 8B broader three-prompt 50-token pack has a passing public summary at `qa/evidence-bundles/llama3-8b-broader-50tok-20260505T005031Z-head-d13541ad8d7e/manifest.json`; the first four-row bounded 512-context pack has a passing public summary at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json`; the earlier exact 8B 512-context pack has a passing public summary at `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json`; and the bounded exact 8B compact chat-template-shapes pack has a passing public summary at `qa/evidence-bundles/llama3-8b-chat-template-shapes-20260505T003821Z-head-d13541ad8d7e/manifest.json`. This does not widen support by itself: broader/full support still requires normalized parity, memory/perf, broader context/template coverage, and durable-bundle evidence after a Tim-authorized validation lane is available again. See `qa/validation-notes/2026-05-12-local-only-validation-lane-paused.md`, `qa/validation-notes/2026-05-04-validation-lane-reopened.md`, `qa/validation-notes/2026-05-04-8b-context-512-rerun.md`, `qa/validation-notes/2026-05-05-four-row-context-512.md`, `qa/validation-notes/2026-05-05-llama32-1b-3b-chat-template-shapes.md`, `qa/validation-notes/2026-05-05-llama32-1b-3b-unique-chat-perf-rss.md`, `qa/validation-notes/2026-05-05-8b-broader-50tok.md`, and `qa/validation-notes/2026-05-05-8b-chat-template-shapes.md`.
