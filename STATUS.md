...
- **8B promotion:** Llama 3 8B Instruct Q8_0 has end-to-end short-context generation parity artifacts: compact parity, a three-prompt 50-token Ubuntu parity run, the bounded compact chat-template-shapes pack, API/frontend smoke, and bounded-memory evidence all agree for the exact tracked Q8_0 GGUF. The 8B 1024 and 2048 bounded context boxes are now promoted from current-head public PASS bundles.
...
- `qa/validation-notes/2026-05-05-llama3-8b-context-1024-blocker.md` records the earlier required 1024 diagnostic timeout for the exact Llama 3 8B Instruct Q8_0 row. It is superseded by the current-head public PASS bundle below; keep it as red-box history, not current support truth.
- `qa/validation-notes/2026-05-05-llama3-8b-context-2048-blocker.md` records the earlier failed 2048 attempt and is now superseded by the current-head public PASS bundle below; keep it as red-box history, not current support truth.
- `qa/evidence-bundles/llama3-8b-context-2048-20260506T144037Z-head-ae672d935a9d/manifest.json` records the clean public `main` current-head third bounded 2048-context pack pass for the exact Llama 3 8B Instruct Q8_0 row: 1910 prompt tokens, generated token IDs `[34,2735,35,12,7854]`, generated text `CMLD-204`, `8:27.08` wall time, timed-process max RSS `17507392 KiB`, and max sampled backend RSS `1537484 KiB`. The bundle is scrubbed and closes only this exact bounded 2048 pack.
...
- The first bounded 512-context pack now passes across all four exact supported Q8_0 rows; this is a checked 512-pack result only, not a 1k/2k/model-native context or portability claim. The exact Llama 3.2 1B and 3B rows also have separate checked 1024-context pack passes, both exact Llama 3.2 rows have separate checked 2048-context pack passes, the exact 8B 1024- and 2048-context packs now have current-head public PASS bundles; each remains limited to its row and prompt pack.
...
- `qa/evidence-bundles/llama3-8b-context-1024-20260506T144810Z-head-ae672d935a9d/manifest.json`
- `qa/evidence-bundles/llama3-8b-context-2048-20260506T144037Z-head-ae672d935a9d/manifest.json`
