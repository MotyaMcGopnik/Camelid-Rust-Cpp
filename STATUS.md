...
- `qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260507T185917Z-head-bb8b616a09d6/manifest.json` plus `SHA256SUMS` is the current-head 8B 1024/2048 bounded-pack PASS evidence for `bb8b616a09d6`; it matched prompt tokens, generated token IDs, and generated text for `CMLD-102` and `CMLD-204`.
...
- The current 8B context support truth for this exact row includes checked 512/1024/2048 bounded packs. The 1024/2048 current-head pass at `bb8b616a09d6` matched the bounded prompt packs exactly and is published at `qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260507T185917Z-head-bb8b616a09d6/manifest.json`. This is still exact-row bounded-pack support, not model-native or broad-family promotion.
...
- `qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260507T185917Z-head-bb8b616a09d6/manifest.json`
