...
50-token pack now matches the known-good baseline, reopened-lane API/WebUI smoke is captured, the second bounded 1024-context pack and third bounded 2048-context pack are captured, and bounded
...
Status: **accepted exact-row parity/API/WebUI smoke with broader three-prompt parity, compact template-shape, bounded 512-context, bounded 1024-context, bounded 2048-context, and unique-chat perf/RSS evidence**
