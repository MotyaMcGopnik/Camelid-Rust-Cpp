...
- Completion response: prompt `hello`, prompt tokens `2`, generated token id `[11]`, text `,`, `backendinference.timings_ms` present, forward total `3738.379 ms`, generate `3744 ms`.
- Chat response: prompt tokens `11`, generated token id `[9906]`, text `Hello`, `backendinference.timings_ms` present, forward total `19891.325 ms`, generate `19898 ms`.
