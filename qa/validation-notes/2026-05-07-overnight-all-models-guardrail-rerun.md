...
- Canonical Ubuntu check via `ssh -i /Users/timtoole/Documents/cert/ubuntu.pem ubuntu@54.69.75.77` showed a stale/self-matching 8B diagnostic watcher (`run-8b-1024-diag-4c30c53`) plus active non-8B `bench-q8-blocks` work for Qwen/Mixtral/Gemma. No duplicate 8B long-context run was started.
