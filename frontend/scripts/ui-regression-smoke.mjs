...
assert.match(chatWorkspaceSource, /message-code-card-status[^>]*aria-live="polite"[^>]*>Still generating — code block open</, 'incomplete streaming code blocks should show a live still-generating badge')
