...
assert.match(dashboardHookSource, /LOCAL_CHAT_DEMO_MAX_TOKENS\s*=\s*800/, 'local chat demo cap should allow complete compact apps instead of clipping code immediately')
