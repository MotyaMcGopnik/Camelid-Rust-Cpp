...
- **Llama 3 8B Instruct Q8_0:** exact-row API/WebUI smoke, clean-main timing/RSS smoke, broader 50-token parity, bounded 512/1024/2048 context packs, compact chat-template-shapes pack, and measurement-only lazy-Q8 hot-path cost probe are represented as bounded exact-row wins without implying model-native/larger-context support, arbitrary-template support, production throughput, portability, or broad Llama-family support.
