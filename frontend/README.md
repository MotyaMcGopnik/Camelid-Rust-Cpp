...
- **Llama 3 8B Instruct Q8_0:** exact-row API/WebUI smoke, clean-main timing/RSS smoke, broader 50-token parity, checked bounded 512/1024/2048 context packs, compact chat-template-shapes pack, structured RSS/Q8 file-read counters, and measurement-only lazy-Q8 hot-path cost probe are represented as bounded exact-row wins only. The current-head 1024/2048 bounded-pack PASS at `../qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260509T041451Z-head-8e26be0a73c0/manifest.json` closes only those exact bounded buckets; older 1024/2048 bundles remain historical source-head evidence. None of this is model-native/larger-context, broad 8B/Llama, production-throughput, or portability support.
