...
- **Llama 3 8B Instruct Q8_0:** exact-row API/WebUI smoke, clean-main timing/RSS smoke, broader 50-token parity, the bounded 512-context pack, compact chat-template-shapes pack, structured RSS/Q8 file-read counters, measurement-only lazy-Q8 hot-path cost probe, and the current-head 1024/2048 bounded-pack PASS at `../qa/evidence-bundles/llama3-8b-context-1024-2048-current-head-20260509T002636Z-head-9e3c64f2cfab/manifest.json` are represented as bounded exact-row wins only for the checked packs/source-runtime head. None of this is model-native/larger-context, broad 8B/Llama, production-throughput, or portability support.
