...
- **Llama 3 8B Instruct Q8_0:** exact-row API/WebUI smoke, clean-main timing/RSS smoke, broader 50-token parity, bounded 512/1024/2048 context packs, compact chat-template-shapes pack, structured RSS/Q8 file-read counters, and measurement-only lazy-Q8 hot-path cost probe are represented as bounded exact-row wins. The 1024/2048 packs are green only for this exact Q8_0 row on current head; prior 1024/2048 PASS artifacts remain historical source-head evidence and none of this is model-native/larger-context, broad 8B/Llama, production-throughput, or portability support.
