...
- **Llama 3 8B Instruct Q8_0:** exact-row API/WebUI smoke, clean-main timing/RSS smoke, broader 50-token parity, the bounded 512-context pack, compact chat-template-shapes pack, structured RSS/Q8 file-read counters, and measurement-only lazy-Q8 hot-path cost probe are represented as bounded exact-row wins. The 1024/2048 packs are not promoted on current head after later runtime/source changes; the `844e8d4709d1` PASS bundle is source-head history until a fresh current-head canonical PASS lands, and none of this is model-native/larger-context, broad 8B/Llama, production-throughput, or portability support.
