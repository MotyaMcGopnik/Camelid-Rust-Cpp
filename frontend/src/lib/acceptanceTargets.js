...
export const LLAMA32_3B_ACCEPTANCE_SUMMARY = 'This exact 3B Q8_0 row is now smoke-supported for short local chat after exact-row /api/models/load, /v1/completions, /v1/chat/completions, frontend smoke, compact parity, broader three-prompt 50-token parity, a five-prompt API smoke pack, and bounded 512/1024/2048-context parity packs. The claim is intentionally narrow: it does not promote neighboring Llama sizes, base variants, other quantizations, model-native/larger contexts beyond the checked packs, production throughput, portability, or broad prompt/chat-template behavior; the 1B and 8B wins are tracked as their own exact rows, not inherited from this 3B row.'
