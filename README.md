...
> **Current public posture:** four exact GGUF rows have evidence-backed support boundaries: TinyLlama at the current validated gate, Llama 3.2 1B/3B Q8_0 through checked bounded 2048-context packs, and Llama 3 8B Q8_0 through the checked bounded 512-context pack only. 8B 1024/2048 remain red until fresh current-head PASS artifacts and synchronized docs/API/frontend copy exist. Wider model-native context, production throughput, portability, arbitrary templates, and broad-family support remain outside the claim.
...
- **The context ladder is explicit.** TinyLlama stays at the current gate with bounded 512-context coverage; Llama 3.2 1B/3B have checked bounded 512/1024/2048-context evidence; Llama 3 8B is green only for the checked bounded 512-context pack while 1024/2048 remain red pending fresh current-head PASS evidence plus synchronized docs/API/frontend copy. These checked packs do not imply model-native/larger context, arbitrary-template, production-throughput, portability, or broader-family support.
...
| Llama 3 8B Instruct Q8_0 | **Verified support (bounded)** | Load, completions, chat completions, WebUI validation, compact parity, three-prompt 50-token parity, the bounded 512-context pack, compact chat-template-shapes pack, bounded memory evidence, and lazy-Q8 hot-path measurements. | 1024/2048 stay red until fresh current-head PASS artifacts and synchronized docs/API/frontend copy exist; do not claim model-native/larger context beyond checked packs, production throughput, arbitrary templates, portability, neighboring-row, or broad 8B/Llama support. |
...
| Llama 3 8B Instruct Q8_0 | 512-context bounded recall pack | PASS | `CMLD-512-CHECK` |
