...
- **Four exact Q8_0 rows are public and evidence-backed.** TinyLlama remains the full current gate; Llama 3.2 1B and Llama 3.2 3B have checked bounded 512/1024/2048 support where row-specific PASS artifacts exist; Llama 3 8B has exact-row smoke plus checked 512/1024/2048-context support on current `main`, backed by the fresh current-head canonical bundle. Mistral 7B Instruct v0.3 remains fail-closed as an active bring-up lane until its current-head promotion checklist is complete.
