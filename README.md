...
| --- | --- | --- | --- |
| TinyLlama 1.1B Chat Q8_0 | Supported current gate | Public row bundle, current-head row manifest, and final-normalization bundle anchor the broader parity/template/context/perf gate for this exact row. | No implied support for adjacent TinyLlama quantizations, arbitrary templates, larger contexts, or other model families. |
| Llama 3.2 1B Instruct Q8_0 | Supported exact-row smoke | Public row bundle, bounded unique-chat perf/RSS envelope, current-head row manifest, four-row 512-context pack, second bounded 1024-context pack, and bounded compact chat-template-shapes pack anchor exact-row smoke for this row only. | Model-native/larger context beyond the checked 512/1024 packs, arbitrary/Jinja template behavior beyond the checked compact pack, production throughput/portability evidence, and no implied support for neighboring rows. |
| Llama 3.2 3B Instruct Q8_0 | Supported exact-row smoke | Public carry-forward smoke bundle, current-head row manifest, post-Q8-dot broader-pack handoff, four-row 512-context pack, second bounded 1024-context pack, third bounded 2048-context pack, bounded compact chat-template-shapes pack, and bounded unique-chat perf/RSS envelope anchor this row only. | Model-native/larger context beyond the checked 512/1024/2048 packs, production throughput/portability evidence, arbitrary/Jinja template behavior beyond the checked compact pack, and no implied support for neighboring rows. |
| Llama 3 8B Instruct Q8_0 | Supported exact-row smoke | Public carry-forward bundle, perf envelope, current-head row manifest, broader 50-token rerun bundle, four-row 512-context pack, compact chat-template-shapes rerun bundle, and lazy-Q8 hot-path cost bundle anchor exact-row smoke plus bounded measurement packs. | Broader/larger context beyond the checked 512 pack, larger prompt packs, arbitrary template execution, stronger performance/portability evidence, and no implied support for neighboring rows. |

TinyLlama and the exact Llama 3.2 1B/3B Instruct Q8_0 plus Llama 3 8B Instruct Q8_0 rows are the supported generation lanes today, with TinyLlama normalized for its current gate and the Llama rows intentionally limited to exact-row short local-chat/parity envelopes. Broader Llama-family support has not been promoted, and nothing adjacent inherits support.

Current validation-lane note: The approved Ubuntu validation lane is reopened. Promotion-grade exact-row runtime reruns should happen there, from clean public `main` checkouts that preserve any dirty remote worktrees. This does not widen support by itself: broader/full support still waits on normalized current-head parity, API/WebUI, memory/perf, and context artifacts for each exact row.
...
- `qa/evidence-bundles/tinyllama-broader-template-context-perf-rss-20260505T044519Z-head-864e07b51f36/manifest.json` plus `SHA256SUMS` is the current-head TinyLlama final-normalization bundle for broader marker-template parity, compact template-shape behavior, bounded 512-context coverage, and backend RSS/perf sampling.
- `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json` plus `SHA256SUMS` is the sanitized public summary for the first bounded 512-context pack across all four exact supported Q8_0 rows.
- `qa/evidence-bundles/llama32-1b-context-1024-20260505T081001Z-head-156ded6fc76b/manifest.json` plus `SHA256SUMS` is the sanitized public summary for the exact Llama 3.2 1B Instruct Q8_0 second bounded 1024-context pack.
- `qa/evidence-bundles/llama32-3b-context-1024-20260505T094258Z-head-c14e5e7b5692/manifest.json` plus `SHA256SUMS` is the sanitized public summary for the exact Llama 3.2 3B Instruct Q8_0 second bounded 1024-context pack.
- `qa/evidence-bundles/llama32-3b-context-2048-20260505T105742Z-head-36ec8e492d65/manifest.json` plus `SHA256SUMS` is the sanitized public summary for the exact Llama 3.2 3B Instruct Q8_0 third bounded 2048-context pack only.
- `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json` plus `SHA256SUMS` is the sanitized public summary for the bounded compact chat-template-shapes pack on the exact Llama 3.2 1B/3B Instruct Q8_0 rows.
- `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json` plus `SHA256SUMS` is the sanitized public summary for the bounded unique-chat perf/RSS envelope on those exact 1B/3B rows.
- `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json` plus `SHA256SUMS` is the sanitized public summary for the earlier exact 8B first 512-context pack rerun.
...
- `qa/evidence-bundles/8b-checkmark-current-head-20260505T052647Z-head-864e07b51f36/manifest.json` plus `SHA256SUMS` is the earlier public-main exact 8B checkmark refresh at head `864e07b51f36`.
- `qa/evidence-bundles/8b-checkmark-current-main-20260505T084931Z-head-15bfc41d15d5/manifest.json` plus `SHA256SUMS` is the latest public-main exact 8B checkmark refresh: API/WebUI/RSS smoke passed at head `15bfc41d15d5` with max sampled backend RSS `286148 KiB`, preserving exact-row smoke only.
...
Current validation-lane note: promotion-grade exact-row remote reruns are back on the approved Ubuntu validation lane. Keep the existing exact-row smoke evidence intact, run fresh evidence from clean public `main` checkouts, and do not widen the claim until the new artifacts pass and docs/API/frontend agree.

Fresh reopened-lane smoke: `qa/evidence-bundles/four-row-api-webui-20260505T003100Z-head-b403884/manifest.json` records passing exact-row API + frontend smoke for TinyLlama, Llama 3.2 1B, Llama 3.2 3B, and Llama 3 8B Q8_0 on a clean public checkout; the earlier API-only summary remains at `qa/evidence-bundles/four-row-api-only-20260504T230722Z-head-13a465608fbf/manifest.json` as a narrower freshness slice. The four-row 512-context pack at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json`, the 1B/3B bounded compact chat-template-shapes pack at `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json`, the 1B/3B bounded unique-chat perf/RSS pack at `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json`, the exact 1B second bounded 1024-context pack at `qa/evidence-bundles/llama32-1b-context-1024-20260505T081001Z-head-156ded6fc76b/manifest.json`, the exact 3B second bounded 1024-context pack at `qa/evidence-bundles/llama32-3b-context-1024-20260505T094258Z-head-c14e5e7b5692/manifest.json`, the exact 3B third bounded 2048-context pack at `qa/evidence-bundles/llama32-3b-context-2048-20260505T105742Z-head-36ec8e492d65/manifest.json`, separate 8B broader three-prompt 50-token rerun at `qa/evidence-bundles/llama3-8b-broader-50tok-20260505T005031Z-head-d13541ad8d7e/manifest.json`, earlier first 8B 512-context rerun at `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json`, compact chat-template-shapes rerun at `qa/evidence-bundles/llama3-8b-chat-template-shapes-20260505T003821Z-head-d13541ad8d7e/manifest.json`, and retained-block lazy-Q8 hot-path cost probe at `qa/evidence-bundles/llama3-8b-lazy-q8-hotpath-20260505T021411Z-head-723a665/manifest.json` now give bounded exact-row coverage, but they are bounded packs/measurements only, not full-support, portability, or arbitrary-template evidence.

- **Llama 3.2 1B Instruct Q8_0:** exact-row load, completions, chat-completions, frontend smoke, compact parity, the broader prompt pack, the first bounded 512-context pack, the second bounded 1024-context pack, the bounded compact chat-template-shapes pack, and the bounded unique-chat perf/RSS envelope are validated for this 1B Instruct Q8_0 row. Durable anchors: `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_1b_instruct_q8_0.bundle.json`, `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_1b_instruct_q8_0/manifest.json`, `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json`, `qa/evidence-bundles/llama32-1b-context-1024-20260505T081001Z-head-156ded6fc76b/manifest.json`, `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json`, and `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json`. This does not promote neighboring Llama sizes, base variants, other quantizations, model-native/larger contexts beyond the checked 512/1024 packs, arbitrary GGUF/Jinja template execution, broad chat-template behavior, production throughput, or portability.
- **Llama 3.2 3B Instruct Q8_0:** exact-row load, completions, chat-completions, frontend smoke, compact prompt-token/1-token/5-token/50-token parity, the broader three-prompt 50-token pack, the first bounded 512-context pack, the second bounded 1024-context pack, the third bounded 2048-context pack, the bounded compact chat-template-shapes pack, and the bounded unique-chat perf/RSS envelope are validated for this 3B Instruct Q8_0 row. Durable anchors: `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_3b_instruct_q8_0.bundle.json` for carry-forward smoke, `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_3b_instruct_q8_0/manifest.json` for the post-Q8-dot broader-pack handoff and next tracks, `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json` for the bounded 512-context row, `qa/evidence-bundles/llama32-3b-context-1024-20260505T094258Z-head-c14e5e7b5692/manifest.json` for the bounded 1024-context row, `qa/evidence-bundles/llama32-3b-context-2048-20260505T105742Z-head-36ec8e492d65/manifest.json` for the bounded 2048-context row, `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json` for bounded compact template-shape coverage, and `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json` for bounded unique-chat perf/RSS coverage. This does not promote neighboring Llama sizes, base variants, other quantizations, model-native/larger contexts beyond the checked 512/1024/2048 packs, arbitrary GGUF/Jinja template execution, broad chat-template behavior, production throughput, or portability. See [`QA_LLAMA32_3B_Q8_ACCEPTANCE.md`](QA_LLAMA32_3B_Q8_ACCEPTANCE.md) and [`STATUS.md`](STATUS.md) for the exact evidence boundary.
- **Llama 3 8B Instruct Q8_0:** the exact tracked Q8_0 GGUF now has end-to-end generation parity artifacts: compact `hello` parity, a three-prompt 50-token Ubuntu parity run where prompt tokens, generated token IDs, and generated text match the known-good reference, plus API/frontend smoke evidence, one passing 512-context pack, one passing compact chat-template-shapes pack, and a retained-block lazy-Q8 hot-path cost probe for representative FFN/output tensors. Durable anchors: `qa/evidence-bundles/four-row-public-20260503T024327Z/llama3_8b_instruct_q8_0.bundle.json` for the pre-promotion guarded-WebUI smoke slice, `qa/evidence-bundles/four-row-perf-portability-public-20260503T025639Z/compact-perf-portability-envelope.json`, `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama3_8b_instruct_q8_0/manifest.json`, `qa/evidence-bundles/llama3-8b-broader-50tok-20260505T005031Z-head-d13541ad8d7e/manifest.json`, `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json`, `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json`, `qa/evidence-bundles/llama3-8b-chat-template-shapes-20260505T003821Z-head-d13541ad8d7e/manifest.json`, `qa/evidence-bundles/llama3-8b-api-webui-rss-clean-20260505T015843Z-head-aee469b9c13a/manifest.json` for clean-main API/WebUI timing smoke, `qa/evidence-bundles/8b-checkmark-current-head-20260505T052647Z-head-864e07b51f36/manifest.json` for the earlier public-main exact-row API/WebUI/RSS checkmark refresh, `qa/evidence-bundles/8b-checkmark-current-main-20260505T084931Z-head-15bfc41d15d5/manifest.json` for the latest public-main exact-row API/WebUI/RSS checkmark refresh, `qa/evidence-bundles/llama3-8b-lazy-q8-hotpath-20260505T021411Z-head-723a665/manifest.json` for hot-path measurement only, and `qa/evidence-bundles/llama3-8b-lazy-q8-hotpath-helper-validated-20260505T0350Z-head-e22307f2f90b/manifest.json` for the clean-main helper-validation repeat. This promotes only the exact Llama 3 8B Instruct Q8_0 row; it does not claim neighboring Llama sizes, other quantizations, larger contexts, arbitrary GGUF/Jinja template execution, broad chat-template behavior, or performance portability.
