...
| Llama 3.2 3B Instruct Q8_0 | Supported exact-row smoke | Public carry-forward smoke bundle, current-head row manifest, post-Q8-dot broader-pack handoff, four-row 512-context pack, second bounded 1024-context pack, bounded compact chat-template-shapes pack, and bounded unique-chat perf/RSS envelope anchor this row only. | Model-native/larger context beyond the checked 512/1024 packs, production throughput/portability evidence, arbitrary/Jinja template behavior beyond the checked compact pack, and no implied support for neighboring rows. |
...
- **Llama 3.2 3B Instruct Q8_0:** exact-row load, completions, chat-completions, frontend smoke, compact prompt-token/1-token/5-token/50-token parity, the broader three-prompt 50-token pack, the first bounded 512-context pack, the second bounded 1024-context pack, the bounded compact chat-template-shapes pack, and the bounded unique-chat perf/RSS envelope are validated for this 3B Instruct Q8_0 row. Durable anchors: `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_3b_instruct_q8_0.bundle.json` for carry-forward smoke, `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_3b_instruct_q8_0/manifest.json` for the post-Q8-dot broader-pack handoff and next tracks, `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json` for the bounded 512-context row, `qa/evidence-bundles/llama32-3b-context-1024-20260505T094258Z-head-c14e5e7b5692/manifest.json` for the bounded 1024-context row, `qa/evidence-bundles/llama32-1b-3b-chat-template-shapes-20260505T060036Z-head-e9f28572e090/manifest.json` for bounded compact template-shape coverage, and `qa/evidence-bundles/llama32-1b-3b-unique-chat-perf-rss-20260505T061644Z-head-e9f28572e090/manifest.json` for bounded unique-chat perf/RSS coverage. This does not promote neighboring Llama sizes, base variants, other quantizations, model-native/larger contexts beyond the checked 512/1024 packs, arbitrary GGUF/Jinja template execution, broad chat-template behavior, production throughput, or portability. See [`QA_LLAMA32_3B_Q8_ACCEPTANCE.md`](QA_LLAMA32_3B_Q8_ACCEPTANCE.md) and [`STATUS.md`](STATUS.md) for the exact evidence boundary.
