...
- `qa/evidence-bundles/four-row-api-webui-20260505T003100Z-head-b403884/manifest.json` is the fresh reopened-lane API + frontend smoke summary for all four exact rows on a clean public checkout.
...
- **Llama 3 8B Instruct Q8_0:** the exact tracked Q8_0 GGUF now has end-to-end generation parity artifacts: compact `hello` parity, a three-prompt 50-token Ubuntu parity run where prompt tokens, generated token IDs, and generated text match the known-good reference, plus API/frontend smoke evidence, one passing 512-context pack, and one passing compact chat-template-shapes pack. Durable anchors: `qa/evidence-bundles/four-row-public-20260503T024327Z/llama3_8b_instruct_q8_0.bundle.json` for the pre-promotion guarded-WebUI smoke slice, `qa/evidence-bundles/four-row-perf-portability-public-20260503T025639Z/compact-perf-portability-envelope.json`, `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama3_8b_instruct_q8_0/manifest.json`, `qa/evidence-bundles/llama3-8b-broader-50tok-20260505T005031Z-head-d13541ad8d7e/manifest.json`, `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json`, `qa/evidence-bundles/llama3-8b-chat-template-shapes-20260505T003821Z-head-d13541ad8d7e/manifest.json`, and `qa/evidence-bundles/llama3-8b-api-webui-rss-clean-20260505T015843Z-head-aee469b9c13a/manifest.json` for clean-main API/WebUI timing smoke. This promotes only the exact Llama 3 8B Instruct Q8_0 row; it does not claim neighboring Llama sizes, other quantizations, larger contexts, arbitrary GGUF/Jinja template execution, or broad chat-template behavior.
