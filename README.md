...
- `qa/evidence-bundles/four-row-api-webui-20260504T233202Z-head-cb8943d/manifest.json` is the fresh reopened-lane API + frontend smoke summary for all four exact rows on a clean public checkout.
...
Fresh reopened-lane smoke: `qa/evidence-bundles/four-row-api-webui-20260504T233202Z-head-cb8943d/manifest.json` records passing exact-row API + frontend smoke for TinyLlama, Llama 3.2 1B, Llama 3.2 3B, and Llama 3 8B Q8_0 on a clean public checkout; the earlier API-only summary remains at `qa/evidence-bundles/four-row-api-only-20260504T230722Z-head-13a465608fbf/manifest.json` as a narrower freshness slice. The separate first 8B 512-context rerun at `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json` now passes, but it is one bounded pack only, not full parity/performance evidence.
...
- **Llama 3 8B Instruct Q8_0:** the exact tracked Q8_0 GGUF now has end-to-end generation parity artifacts: compact `hello` parity, a three-prompt 5-token Ubuntu parity run where prompt tokens, generated token IDs, and generated text match the known-good reference, plus API/frontend smoke evidence and one passing 512-context pack. Durable anchors: `qa/evidence-bundles/four-row-public-20260503T024327Z/llama3_8b_instruct_q8_0.bundle.json` for the pre-promotion guarded-WebUI smoke slice, `qa/evidence-bundles/four-row-perf-portability-public-20260503T025639Z/compact-perf-portability-envelope.json`, `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama3_8b_instruct_q8_0/manifest.json`, and `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json`. This promotes only the exact Llama 3 8B Instruct Q8_0 row; it does not claim neighboring Llama sizes, other quantizations, larger contexts, or broad chat-template behavior.
