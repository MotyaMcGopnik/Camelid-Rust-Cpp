...
| Llama 3.2 1B Instruct Q8_0 | Supported exact-row smoke | Public row bundle, perf envelope, current-head row manifest, and the four-row 512-context pack anchor exact-row smoke for this row only. | Broader/larger context beyond the first bounded 512 pack, broader chat-template behavior, performance/portability evidence, and no implied support for neighboring rows. |
| Llama 3.2 3B Instruct Q8_0 | Supported exact-row smoke | Public carry-forward smoke bundle, current-head row manifest, post-Q8-dot broader-pack handoff, and the four-row 512-context pack anchor this row only. | Broader/larger context beyond the first bounded 512 pack, stronger perf/portability evidence, and no implied support for neighboring rows. |
...
Fresh reopened-lane smoke: `qa/evidence-bundles/four-row-api-webui-20260505T003100Z-head-b403884/manifest.json` records passing exact-row API + frontend smoke for TinyLlama, Llama 3.2 1B, Llama 3.2 3B, and Llama 3 8B Q8_0 on a clean public checkout; the earlier API-only summary remains at `qa/evidence-bundles/four-row-api-only-20260504T230722Z-head-13a465608fbf/manifest.json` as a narrower freshness slice. The four-row 512-context pack at `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json`, separate 8B broader three-prompt 50-token rerun at `qa/evidence-bundles/llama3-8b-broader-50tok-20260505T005031Z-head-d13541ad8d7e/manifest.json`, earlier first 8B 512-context rerun at `qa/evidence-bundles/llama3-8b-context-512-20260504T234625Z-head-58acf592345c/manifest.json`, compact chat-template-shapes rerun at `qa/evidence-bundles/llama3-8b-chat-template-shapes-20260505T003821Z-head-d13541ad8d7e/manifest.json`, and retained-block lazy-Q8 hot-path cost probe at `qa/evidence-bundles/llama3-8b-lazy-q8-hotpath-20260505T021411Z-head-723a665/manifest.json` now give bounded exact-row coverage, but they are bounded packs/measurements only, not full-support, portability, or arbitrary-template evidence.

- **Llama 3.2 1B Instruct Q8_0:** exact-row load, completions, chat-completions, frontend smoke, compact parity, the broader prompt pack, and the first bounded 512-context pack are validated for this 1B Instruct Q8_0 row. Durable anchors: `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_1b_instruct_q8_0.bundle.json`, `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_1b_instruct_q8_0/manifest.json`, and `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json`. This does not promote neighboring Llama sizes, base variants, other quantizations, larger contexts beyond the checked 512 pack, or broad chat-template behavior.
- **Llama 3.2 3B Instruct Q8_0:** exact-row load, completions, chat-completions, frontend smoke, compact prompt-token/1-token/5-token/50-token parity, the broader three-prompt 50-token pack, and the first bounded 512-context pack are validated for this 3B Instruct Q8_0 row. Durable anchors: `qa/evidence-bundles/four-row-public-20260503T024327Z/llama32_3b_instruct_q8_0.bundle.json` for carry-forward smoke, `qa/evidence-bundles/four-row-current-head-20260503T061958Z-head-34b954498a03/llama32_3b_instruct_q8_0/manifest.json` for the post-Q8-dot broader-pack handoff and next tracks, and `qa/evidence-bundles/four-row-context-512-20260505T051510Z-head-b403884/manifest.json` for the bounded 512-context row. This does not promote neighboring Llama sizes, base variants, other quantizations, larger contexts beyond the checked 512 pack, or broad chat-template behavior. See [`QA_LLAMA32_3B_Q8_ACCEPTANCE.md`](QA_LLAMA32_3B_Q8_ACCEPTANCE.md) and [`STATUS.md`](STATUS.md) for the exact evidence boundary.
