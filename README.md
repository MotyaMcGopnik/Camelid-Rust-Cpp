...
> **Current public posture:** four exact GGUF rows have evidence-backed support boundaries: TinyLlama at the current validated gate, Llama 3.2 1B/3B Q8_0 through checked bounded 2048-context packs, and Llama 3 8B Q8_0 through checked bounded 512/1024/2048-context packs. Wider model-native context, production throughput, portability, arbitrary templates, and broad-family support remain outside the claim.
...
| Llama 3 8B Instruct Q8_0 | **Verified support (bounded)** | Load, completions, chat completions, WebUI validation, compact parity, three-prompt 50-token parity, bounded 512/1024/2048-context packs, compact chat-template-shapes pack, bounded memory evidence, and lazy-Q8 hot-path measurements. | Do not claim model-native/larger context beyond checked packs, production throughput, arbitrary templates, portability, neighboring-row, or broad 8B/Llama support. |
