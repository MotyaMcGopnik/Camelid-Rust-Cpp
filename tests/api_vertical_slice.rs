...
async fn capabilities_report_support_contract_and_planned_lanes() {
    ...
    assert_eq!(
        ...
        "Four exact Q8_0 rows: TinyLlama current gate; exact Llama 3.2 1B/3B smoke rows and exact Llama 3 8B smoke row with checked bounded 512/1024/2048-context packs. Model-native/larger context beyond checked packs, throughput, portability, and broad family support remain unsupported."
    );
